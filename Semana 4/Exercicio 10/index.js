...
const verificaEstacao = event => {
  ...
  if (
    ...
    atualizaEstacao({ texto: 'Outono', url: './assets/outono.jpg' })
  ...
  if (
    ...
    atualizaEstacao({ texto: 'Inverno', url: './assets/inverno.jpg' })
  ...
  if (
    ...
    atualizaEstacao({ texto: 'Primavera', url: './assets/primavera.jpg' })

    return
  }

  atualizaEstacao({ texto: 'Verão', url: './assets/verao.jpg' })
}
